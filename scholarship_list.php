...
if(isset($-POST['appprove'])){
 $sql = ""UPDATE scholarship_list SET application_status= "Approved" ;
}
 else if(isset($_POST['decline'])) {
 $sql = ""UPDATE scholarship_list SET application_status= "Declined" ;
}
  else if(isset($_POST['reset'])) {
$sql = ""UPDATE scholarship_list SET application_status= "Pending" ;
...
?>
      ...
      <div class="col-md-2" id="approval" id="decline"> <?php echo $row[3]?> </div>      
      <div class="col-md-2"> <?php echo $row[4]?> </div>
      <div class="col-md-2"> <input type="submit" class="btn btn-primary" name="approve" id="approve" value="Approve">
<input type="submit" class="btn btn-primary" name="decline" id="decline" value="Decline"> </div>
      </div>
<?php
}
}
...
?> 
 <div class="col-md-2"> <input class="btn btn-primary" type="reset" name="reset" id="reset" value="Reset">  </div>

						...
						<div class="slider-content">
							...
							<div class="title1"> <h2 style="color: white;"> Scholarship List</h2> </div>
								...
								if (mysqli_query($conn, $sql)) {
									echo "<h5 style='color:white;background-color:#3ec1d5;display:inline-block;padding:5px 10px'> Status updated successfully! </h5>";
								} else {
...
?>
							...
							<div style="margin-left:10%; margin-right:10%; margin-top: 50px; margin-bottom: 60px; text-align:center;background: rgba(120, 120, 120,0.5);">
								<div class="row" style="padding:5px; background-color: rgba(32,32,32,0.6); color:#8cb3d9;">
...
<?php
								...
								if (mysqli_num_rows($result) != 0) {
									while($row=mysqli_fetch_array($result)){
										...
										<div class="row" style="padding:1px;">
											...
											<div class="col-md-2" id="status"> <?php echo $row[3]?> </div>      
											<div class="col-md-2"> <?php echo $row[4]?> </div>

											<div class="col-md-2"> 
												<a href='status_update.php?id=<?php echo $row[5]?>&status=approve'>
													<input type="submit" class="btn btn-primary" name="approve" id="approve" value="Approve">
												</a> 
												<a href='status_update.php?id=<?php echo $row[5]?>&status=decline'>
													<input type="submit" class="btn btn-primary" name="decline" id="decline" value="Decline">
												</a> 
											</div>
										</div>
								...
								<div class="col-md-2"> <a href='status_update.php?id=<?php echo $row[5]?>&status=reset'><input class="btn btn-primary" type="reset" name="reset" id="reset" value="Reset"> </a></div>
